...
{
    public partial class AddClientType : Form
    {
        private UserManagment mainForm;
        public AddClientType(UserManagment form)
        {
            InitializeComponent();
            this.mainForm = form;
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            userService.insertClientType(model);
            MessageBox.Show("Haz agregado satisfactoriamente un tipo cliente.");
            cleanText();
